...
#df=reader("C:/Users/Trainee/Desktop/specTools/specTools/proximal_spectra_tool_data/data/soil_00005.asd")
#plt.plot(df.wavelengths,df.__getattr__('white_reference'))
#data=pd.DataFrame(df.__getattr__('radiance'))
