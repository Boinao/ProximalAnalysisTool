...
a = Analysis(['MainViewer.py'],
             pathex=[],
             binaries=[],
             datas=[('D:/Proximal/ProximalAnalysisTool/Vegetation_index_sig_asd.csv', '.'), ('D:/Proximal/ProximalAnalysisTool/prosail/*.txt', 'prosail/'), ('D:/Proximal/ProximalAnalysisTool/external', 'external/'), ('D:/Proximal/ProximalAnalysisTool/images', 'images/'), ('D:/Proximal/ProximalAnalysisTool/Required/numpy', 'numpy/'), ('D:/Proximal/ProximalAnalysisTool/Required/pandas', 'pandas/'), ('D:/Proximal/ProximalAnalysisTool/Required/scipy', 'scipy/'), ('D:/Proximal/ProximalAnalysisTool/Required/seaborn', 'seaborn/'), ('D:/Proximal/ProximalAnalysisTool/Required/sklearn', 'sklearn/')],
             hiddenimports=hiddenimports,
             hookspath=[],
             hooksconfig={},
             runtime_hooks=[],
             excludes=['jedi', 'psutil', 'tornado', 'cryptography', 'h5py', 'notebook', 'torch', 'parso', 'dask', 'certifi', 'cvxopt', 'tk', 'tcl', 'tcl8', 'IPython', 'babel'],
