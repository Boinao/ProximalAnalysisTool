...
# Form implementation generated from reading ui file 'promoted_widget.ui'
#
...
class Ui_Visualizer(object):
    def setupUi(self, Visualizer):
        ...
        Visualizer.resize(811, 487)
        self.verticalLayout = QtWidgets.QVBoxLayout(Visualizer)
        self.verticalLayout.setObjectName("verticalLayout")
        self.tabWidget_4 = QtWidgets.QTabWidget(Visualizer)
        self.tabWidget_4.setObjectName("tabWidget_4")
        self.tab_29 = QtWidgets.QWidget()
        self.tab_29.setObjectName("tab_29")
        self.gridLayout_8 = QtWidgets.QGridLayout(self.tab_29)
        self.gridLayout_8.setObjectName("gridLayout_8")
        self.groupBox_34 = QtWidgets.QGroupBox(self.tab_29)
        self.groupBox_34.setObjectName("groupBox_34")
        self.gridLayout = QtWidgets.QGridLayout(self.groupBox_34)
        ...
        self.verticalLayout_6.addWidget(self.radioClassDistribute)
        ...
        self.verticalLayout_7.addWidget(self.x1CoordEdit_11)
        self.verticalLayout_8.addLayout(self.verticalLayout_7)
        self.horizontalLayout_62 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_62.setObjectName("horizontalLayout_62")
        self.verticalLayout_8.addLayout(self.horizontalLayout_62)
        self.groupBox_42 = QtWidgets.QGroupBox(self.groupBox_34)
        self.groupBox_42.setObjectName("groupBox_42")
        self.horizontalLayout = QtWidgets.QHBoxLayout(self.groupBox_42)
        ...
        self.horizontalLayout.addLayout(self.verticalLayout_100)
        self.verticalLayout_8.addWidget(self.groupBox_42)
        self.horizontalLayout_63 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_63.setObjectName("horizontalLayout_63")
        self.verticalLayout_8.addLayout(self.horizontalLayout_63)
        self.gridLayout.addLayout(self.verticalLayout_8, 0, 0, 1, 1)
        self.gridLayout_8.addWidget(self.groupBox_34, 0, 0, 1, 1)
        self.mplWidgetSpectral_5 = QMatplotlibWidget(self.tab_29)
        self.mplWidgetSpectral_5.setObjectName("mplWidgetSpectral_5")
        self.gridLayout_8.addWidget(self.mplWidgetSpectral_5, 0, 1, 2, 1)
    ...
    def retranslateUi(self, Visualizer):
        ...
        Visualizer.setWindowTitle(_translate("Visualizer", "Form"))
        self.groupBox_34.setTitle(_translate("Visualizer", "Category"))
        self.rb_sep_all_5.setText(_translate("Visualizer", "All Spectra (Mean & Standard Deviation)"))
        self.rb_sep_compare_5.setText(_translate("Visualizer", "Compare Two Class Spectra"))
        self.radioClassDistribute.setText(_translate("Visualizer", "Continum Removal"))
        self.label_73.setText(_translate("Visualizer", "Baseline"))
        self.x1CoordEdit_11.setText(_translate("Visualizer", "0.93"))
        self.groupBox_42.setTitle(_translate("Visualizer", "Compare"))
        self.label_58.setText(_translate("Visualizer", "Class A"))
        self.label_59.setText(_translate("Visualizer", "Class B"))
        self.tabWidget_4.setTabText(self.tabWidget_4.indexOf(self.tab_29), _translate("Visualizer", "Spectral View"))
        self.groupBox_35.setTitle(_translate("Visualizer", "Category"))
        self.radioFeatureVar.setText(_translate("Visualizer", "Band Plot"))
        self.label_75.setText(_translate("Visualizer", "Wavelength"))
        self.x1CoordEdit_13.setText(_translate("Visualizer", "400"))
        self.tabWidget_4.setTabText(self.tabWidget_4.indexOf(self.tab_44), _translate("Visualizer", "Distribution"))
        self.groupBox_38.setTitle(_translate("Visualizer", "Methods"))
        self.radioFTEST_5.setText(_translate("Visualizer", "Spectral Discrimination Index"))
        self.radioSEP_5.setText(_translate("Visualizer", "Oneway Anova"))
        self.radioMUTUAL_5.setText(_translate("Visualizer", "Tukey’s multi-comparison"))
        self.label_67.setText(_translate("Visualizer", "Wavelength"))
        self.x1CoordEdit_10.setText(_translate("Visualizer", "400"))
        self.radioTREE_5.setText(_translate("Visualizer", "Kruskal Wallis Non-Parametric H Test"))
        self.groupBox_39.setTitle(_translate("Visualizer", "Compare"))
        self.label_63.setText(_translate("Visualizer", "Class A"))
        self.label_64.setText(_translate("Visualizer", "Class B"))
        self.tabWidget_4.setTabText(self.tabWidget_4.indexOf(self.tab_33), _translate("Visualizer", "Band Seperability"))
        self.groupBox_40.setTitle(_translate("Visualizer", "Category"))
        self.radio_classcorr_5.setText(_translate("Visualizer", "Band Correlation"))
        self.tabWidget_4.setTabText(self.tabWidget_4.indexOf(self.tab_34), _translate("Visualizer", "Band Correlation"))
        self.groupBox_43.setTitle(_translate("Visualizer", "Category"))
        self.radio_classcorr_6.setText(_translate("Visualizer", "Statistics"))
        self.label_74.setText(_translate("Visualizer", "Parameter"))
        self.tabWidget_4.setTabText(self.tabWidget_4.indexOf(self.tab), _translate("Visualizer", "Class Vs Metadata"))
        self.groupBox_45.setTitle(_translate("Visualizer", "Category"))
        self.radio_classcorr_8.setText(_translate("Visualizer", "Single parameter"))
        self.label_77.setText(_translate("Visualizer", "Parameter"))
        self.radioButton.setText(_translate("Visualizer", "All Parameter"))
        self.tabWidget_4.setTabText(self.tabWidget_4.indexOf(self.tab_2), _translate("Visualizer", "Metadata_Statistics"))
