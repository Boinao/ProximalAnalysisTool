...
from Ui.ui_inOutSelector import Ui_GdalToolsInOutSelector
...
class GdalToolsInOutSelector(QWidget, Ui_GdalToolsInOutSelector):
    ...
    def __init__(self, parent=None, typ=None):
    ...
    def setType(self, typ):
        ...
        if typ & self.MULTIFILE:  # MULTITYPE IS NOT IMPLEMENTED YET
            typ = typ & ~self.MULTIFILE
