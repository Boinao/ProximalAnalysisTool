...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollArea.setGeometry(QtCore.QRect(9, 9, 35, 18))
        ...
        self.textBrowser.setGeometry(QtCore.QRect(9, 483, 1097, 150))
        self.textBrowser.setMaximumSize(QtCore.QSize(16777215, 150))
        self.textBrowser.setObjectName("textBrowser")
        self.widget = QtWidgets.QWidget(self.centralwidget)
        self.widget.setObjectName("widget")
        self.progress_OK = QtWidgets.QHBoxLayout(self.widget)
        self.progress_OK.setContentsMargins(0, 0, 0, 0)
