...
def run_inputCheck(factor,soil_spectrum1,soil_spectrum2,rsoil0,rsoil,psoil):
    ...
    return soil_spectrum1, soil_spectrum2

def run_foursail(factor,refl, trans,lidfa, lidfb, typelidf,
                                             lai, hspot,
                                             tts, tto, psi, rsoil0):
...
def run_prosail(n, cab, car,  cbrown, cw, cm, lai, lidfa, hspot,
    ...
    #         )
    ################################################################################
    soil_spectrum1, soil_spectrum2=run_inputCheck(factor, soil_spectrum1, soil_spectrum2, rsoil0, rsoil, psoil)
    ...
    return run_foursail(factor,refl, trans, lidfa, lidfb, typelidf, lai, hspot, tts, tto, psi, rsoil0)
